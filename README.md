...
> **Enhanced fork notes:** this tree adds a **Network & cache** settings page so you can tune demuxer cache size, readahead/cache time, video/audio decoder threads, and streaming reconnect options. See [ENHANCEMENTS.md](./ENHANCEMENTS.md). Local files and network streams (HTTP/HLS/etc.) are both supported from the home screen.
...
- Smoother PiP
- **Configurable multi-thread decoding & cache/readahead time** (this fork)
